...
public class CalculateTheMatchScoreService {
    ...
    private void scoringDuringExtraGames(Score score1, Score score2, MatchScore matchScore) {
    ...
    private void regularTimeScoring(Score score1, Score score2, MatchScore matchScore) {
    ...
    private void settingPoint(MatchScore matchScore, Score score1, Score score2) {
        if (matchScore.isDop()) {
            scoringDuringExtraGames(score1, score2, matchScore);
        } else {
            regularTimeScoring(score1, score2, matchScore);
        }
    }
